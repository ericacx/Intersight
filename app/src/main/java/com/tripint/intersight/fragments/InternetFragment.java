...
import com.tripint.intersight.pulltorefreshrecyclerview.self.PullToRefreshRecyclerView;
import com.tripint.intersight.pulltorefreshrecyclerview.self.pulltorefresh.PtrrvBaseAdapter;
...
public class InternetFragment extends Fragment {
    ...
    private void findViews(View view) {
        ...
        mPtrrv.setLayoutManager(new GridLayoutManager(getContext(), 4));
        ...
        mAdapter = new PtrrvAdapter(getContext());
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MSG_CODE_REFRESH) {
                ...
                if (mAdapter.getItemCount() == DEFAULT_ITEM_SIZE + ITEM_SIZE_OFFSET) {
                    //over
                    Toast.makeText(getContext(), R.string.nomoredata, Toast.LENGTH_SHORT).show();
