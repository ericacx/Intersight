package com.tripint.intersight.popwindow;
...
import com.tripint.intersight.activity.PhotoResetActivity;
import com.tripint.intersight.activity.RegisterActivity;
import com.tripint.intersight.activity.TopicActivity;
...
public class MoreWindow extends PopupWindow implements OnClickListener {
	...
	private void closeAnimation(ViewGroup layout){
		for(int i=0;i<layout.getChildCount();i++){
			...
			if(child.getId() == R.id.more_window_topic){
				mHandler.postDelayed(new Runnable() {
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.more_window_topic:
			intent.setClass(mContext, TopicActivity.class);
			mContext.startActivity(intent);
			break;
		case R.id.more_window_talk:
			intent.setClass(mContext, PhotoResetActivity.class);
